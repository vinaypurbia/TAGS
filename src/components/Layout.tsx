        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 text-[11px] font-bold uppercase tracking-widest">
          ...
          <div className="space-y-4 max-w-xs">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://www.facebook.com/TAGSUDR" target="_blank" rel="noopener noreferrer"
                className="text-white hover:text-[#FA5600] transition-colors" title="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                </svg>
              </a>
              <a href="https://instagram.com/tags.udr" target="_blank" rel="noopener noreferrer"
                className="text-white hover:text-[#FA5600] transition-colors" title="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/@tagsudr" target="_blank" rel="noopener noreferrer"
                className="text-white hover:text-[#FA5600] transition-colors" title="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/916350021226" target="_blank" rel="noopener noreferrer"
                className="text-white hover:text-[#FA5600] transition-colors" title="WhatsApp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 opacity-80 flex flex-col normal-case font-normal text-xs">
              ...
              <li className="flex items-start gap-2"><MapPin className="w-3.5 h-3.5 text-[#FA5600] mt-0.5 shrink-0" />
