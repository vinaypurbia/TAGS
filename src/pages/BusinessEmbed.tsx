...
type Module = 'dashboard' | 'orders' | 'sales' | 'purchase-orders' | 'cashflow' | 'expenses' | 'suppliers' | 'customers' | 'reports' | 'users' | 'financing' | 'regenerate';
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-2xl border-2 border-gray-100 p-5 space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-3 space-y-1">
          ...
          {scope === 'full' && <p className="text-xs text-gray-600 font-semibold">✅ Advance payment cashflow entries</p>}
        ...
        <div className="bg-white rounded-2xl border-2 border-green-200 p-5 space-y-3">
          ...
          {result.log && (
            <div className="bg-gray-50 rounded-xl p-3 space-y-1 max-h-48 overflow-y-auto">
              <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Log:</p>
